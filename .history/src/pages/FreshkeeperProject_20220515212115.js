      ...
      <UxProject>
        ...
        <div className='insightsWrapper'>
          ...
          <div className='insightsContainer'>
            ...
            <p>
              Scanning don't work well, according to the competitor analysis, so
              it's better tomanually add items, but how?
            </p>
          </div>
          <div className='insightsContainer'>
            <h1>Be able to categorize</h1>
            <p>
              to more easily find specific food item in the App and at home.
            </p>
          </div>
        </div>
      </UxProject>
