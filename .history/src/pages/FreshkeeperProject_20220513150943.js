    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='subHeader'>
          ...
          consumption. We dicided to focus on food waste. First part of the
          discovery was to have a quick brainstorm session to expolre different
          ideas. The main idea we choose to
        </p>
