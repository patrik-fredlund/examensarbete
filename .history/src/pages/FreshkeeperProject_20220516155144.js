    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='MiddleIngressParagraph'>
          ...
          <br />
          To learn from them I decided to go directly to their users by reading
          the customer reviews of those apps. In that way I could get insight in
          the users <span className='bold'>pains</span> and{' '}
          <span className='bold'>gains</span> when using that app, and use that
          to my advantage. I would also get valuble knowledge of the user needs
          when using an app like this.
          <img
            className='reviews'
