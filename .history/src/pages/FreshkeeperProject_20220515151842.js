      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            insight in the users <span className='bold'>pros</span> and{' '}
            <span className='bold'>cons</span> when using that app, and use that
            to my advantage. I would also get valuble knowledge of the user
        ...
        <h2 className='projectSubTitle'>Pains</h2>
        <p className='MiddleIngressParagraph'>
          Also has shopping list. Can add own storage spaces. The interface is
