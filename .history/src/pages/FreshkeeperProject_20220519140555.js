    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          to build a tree of names and in the end the perfect name will appear
          and blom, so to speak. If it's possible the name needs to tick all the
          boxes of the features of the App. I started with writting down words
          realted to the subject:
        </p>
        <div className='insightsWrapper'>
          <div className='insightsContainer'>
