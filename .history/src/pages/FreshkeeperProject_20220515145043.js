      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            reading the customer reviews. In that way I could: get an insight in
            the users pains and gains when using that app, and use that to my
            advantage. I would also get valuble info knowledge of the user needs
