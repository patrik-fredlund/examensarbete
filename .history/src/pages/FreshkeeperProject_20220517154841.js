    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          The first part of the dicovery was to choose a problem to solve with
          food consumption. We decided to focus on food waste because according
          to the Swedish National Food Administration:
        </p>
        ...
        <div className='painGainWrapper'>
          <div className='painGainContainer'>
            ...
            <ul className='painsList'>
              ...
              <li>Can't to share account with others.</li>
        ...
        <div className='insightsWrapper'>
          ...
          <div className='insightsContainer'>
            ...
            <p>
              ...
              not on the same place. That makes this app an inventory of your
        ...
        <p className='ingressParagraph'>
          ...
          expanding because of the reseach of competitors and target group. Now
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          Next step is create a sketch of the main userflow of the prioritized
          functions, to get a sence of the journey and to see if it's working as
          planned.
        </p>
        ...
        <hr />
        <p className='subHeader'>
          Thank you for taking your time out and checking out my work. Please
          feel free to get back to me for some feedback or just to say hi. Have
          a good day!
        </p>
