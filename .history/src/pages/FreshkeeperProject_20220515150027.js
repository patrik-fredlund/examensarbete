      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            reading the customer reviews. In that way I could get insight in the
            users <span className='bold'>pains</span> and{' '}
            <span className='bold'>gains</span> when using that app, and use
            that to my advantage. I would also get valuble info knowledge of the
            user needs when using an app like this.
            <img
              className='reviews'
