        ...
        <div className='uxProjectWrapperYellow'>
          <div className='uxProjectContainer'>
            <p>
              ...
              kilos of edible food are thrown in the rubbish and 26 kilos of
              food and drink are poured into the bin. The figures apply per
              person and year. Much of the food is thrown away because it is not
              eaten in time.
            </p>
          </div>
        </div>
