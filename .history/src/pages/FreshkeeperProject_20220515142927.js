      ...
      <UxProject>
        ...
        <div className='competitorsContainer'>
          ...
          <p className='MiddleIngressParagraph'>
            ...
            To find out what are thier pains and gains I decided to learn
            directly from thier users by reading the customer reviews. In that
            way I good learn what thier users think and feel, and use that to my
            adsvantage.
            <img
              className='icu'
