        ...
        <div className='insightsWrapper'>
          ...
          <div className='competitorsContainer'>
            ...
            <p className='ingressParagraph'>
              ...
              the register item and add expiration date and get an reminder when
              the date is close. From the target group research I also got alot
              of useful feedback as to what's imoportant to them when using
              these features. So now it's time to develop those features in
              detail to reach the user needs. From the feedback I also learned
              that the user would value additional features of the App. First
              step is to write down all features in order of importance.
            </p>
            <h2 className='projectSubTitle'>
