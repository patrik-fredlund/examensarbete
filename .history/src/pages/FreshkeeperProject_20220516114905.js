    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='insightsWrapper'>
          ...
          <p className='ingressParagraph'>
            That's the dicovery part of the analysis with lots of interesting
            information. The outlines of an app is starting to take shape. Some
            of the more interesting insights was e.g that it's not just an app
            to keep track of your foods expiration date, but also an inventory
            space/cloud of your storages. So the features and value of the app
            is growing thanks to the reseach of competitors and target group.
            Now it's time to define these insights and se what they really mean.
          </p>
        </div>
        {/* 
        <div className='competitorsContainer'>
