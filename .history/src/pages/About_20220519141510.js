    ...
    <Wrapper>
      ...
      <AboutContainer>
        <p className='aboutIngress'>
          I am a <b className='bolder'>curious creative and driven problem-solver</b> with a hunger
          to work with an <b className='bolder'>inspiring team,</b> with exciting projects from
          scratch. I just <b className='bolder'>graduated</b> from KYH where I studied{' '}
          <b className='bolder'>Frontend Development,</b> to learn to design on the web. Since
          erlier I have a <b className='bolder'>BA(hons) in graphic design</b> with a focus on
          typography, from University College for the Creative Arts at Farnham,
          England. <br /> My strengths are in <b className='bolder'>problem solving</b> and{' '}
          ...
          What you can expect from me is <b className='bolder'>drive and energy</b className='bolder'> I would love to
          work in a creative environment with an inspiring team. <br /> I’m also{' '}
          <b className='bolder'> happy, loyal and humble.</b> So you will get an{' '}
          <b className='bolder'>educated and modest team player through thick and thin, 24/7.</b>
        </p>
