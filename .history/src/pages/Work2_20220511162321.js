      ...
      <Wrapper>
        ...
        <div className='ingressContainer'>
          <p className='ingressText'>
            ...
            graphic design, but instead of communicating in print, it's all
            about speaking to the target audience online. Below you can have a
            look at some of my UX cases.
          </p>
        </div>
        <ProjectsWrapper>
