      ...
      <UxProject>
        <div className='uxProjectWrapper'>
          <div className='uxProjectContainer'>
            <h1>Project brief</h1>
            <p>
              Sustainable food production / food consumption More and more
              people are beginning to realize the importance of developing more
              sustainable services and functions that do not deplete ecosystem
              resources. But how do we do that? Identify a problem that you want
              to explore further and that you would like to solve in some way.
