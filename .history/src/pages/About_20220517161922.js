    ...
    <Wrapper>
      ...
      <AboutContainer>
        <p className='aboutIngress'>
          ...
          Arts at Farnham, England. My strengths are in problem solving and
          graphic design, and I believe the content, words and language are as
          important/interesting to work with, as the visuals. What you can
          expect from me is drive. Because I long to work in a creative
          environment with an inspiring team more than anything else. I’m also
          happy, loyal and humble. So you get an educated and modest teamplayer
