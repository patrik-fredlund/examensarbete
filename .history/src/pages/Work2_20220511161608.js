      ...
      <Wrapper>
        ...
        <div className='ingressContainer'>
          <p className='ingressText'>
            Below you can have a look at some of my UX cases. During my studies
            in frontend development I discovered my love for UX design, and
            especielly the research part. Since I have a background in graphic
            communication I feel UX design reminds me of that,
          </p>
        </div>
        <ProjectsWrapper>
