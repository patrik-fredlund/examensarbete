    ...
    <Wrapper>
      ...
      <AboutContainer>
        <p className='aboutIngress'>
          I am a <b>curious creative and driven problem-solver</b> with a hunger
          to work with an <b>inspiring team,</b> with exciting projects from
          scratch. I just <b>graduated</b> from KYH where I studied{' '}
          <b>Frontend Development,</b> to learn to design on the web. Since
          erlier I have a <b>BA(hons) in graphic design</b> with a focus on
          typography, from University College for the Creative Arts at Farnham,
          England. <br /> My strengths are in <b>problem solving</b> and{' '}
          <b>graphic design</b> , and{' '}
          <b>
            I believe the content, words and language are as
            important/interesting to work with, as the visuals.{' '}
          </b>{' '}
          What you can expect from me is <b>drive and energy</b> I would love to
          work in a creative environment with an inspiring team. <br /> I’m also{' '}
          <b> happy, loyal and humble.</b> So you will get an{' '}
          <b>educated and modest team player through thick and thin, 24/7.</b>
        </p>
