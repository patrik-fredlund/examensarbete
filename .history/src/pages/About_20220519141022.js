    ...
    <Wrapper>
      ...
      <AboutContainer>
        <p className='aboutIngress'>
          ...
          scratch. I just graduated from KYH where I studied Frontend
          Development, to learn to design on the web. Since erlier I have a
          BA(hons) in graphic design with a focus on typography, from University
          College for the Creative Arts at Farnham, England. <br /> My strengths
          are in problem solving and graphic design, and I believe the content,
          words and language are as important/interesting to work with, as the
          visuals. What you can expect from me is drive. I would love to work in
          a creative environment with an inspiring team. <br /> I’m also happy,
          loyal and humble. So you will get an educated and modest team player
          through thick and thin, 24/7.
        </p>
