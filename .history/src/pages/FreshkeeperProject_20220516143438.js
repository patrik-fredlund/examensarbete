      ...
      <UxProject>
        ...
        <div className='insightsWrapper'>
          ...
          <div className='competitorsContainer'>
            ...
            <p className='ingressParagraph'>
              I'we allready decied about the main features of the app: the
              ...
              features, and additional features the users would like in the App
              to add value of the service.
            </p>
            <h2 className='projectSubTitle'>
