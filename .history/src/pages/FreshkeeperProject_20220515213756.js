    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          space/cloud of your storages. Now it's time to define these insights
          and se what they really mean.
        </p>
        <hr />
        ...
        <p className='ingressParagraph'>
          ...
          cumque harum a corporis? Dolorem voluptas aspernatur, fugit incidunt
          optio aperiam, necessitatibus eos, ipsum neque asperiores soluta
          repellat saepe nemo enim.
        </p>
      </UxProject>
    </Wrapper>
  );
