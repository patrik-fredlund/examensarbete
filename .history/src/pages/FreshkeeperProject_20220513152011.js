    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <div className='uxProjectWrapperYellow'>
          <div className='uxProjectContainer'>
            First part of the dicovery was to choose a problem to solve with
            food consumption. We decided to focus on food waste beacouse:
            According to the National Food Administration, approximately 19
            kilos of edible food are thrown in the rubbish and 26 kilos of food
            and drink are poured into the bin. The figures apply per person and
            year. Much of the food is thrown away because it is not eaten in
            time.
          </div>
        </div>
