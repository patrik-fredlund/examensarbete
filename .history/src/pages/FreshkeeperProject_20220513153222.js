    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='ingressParagraph'>
          ...
          consumption. We decided to focus on food waste beacouse according to
        ...
        <div className='uxProjectWrapperYellow'>
          <div className='uxProjectContainer'>
            <p className='posItText'>
              ...
              and 26 kilos of food <br /> and drink are poured into the bin. The
              figures apply per person and year. <br />
              <span className='bold'>
