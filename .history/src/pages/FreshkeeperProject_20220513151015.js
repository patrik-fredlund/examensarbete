    ...
    <Wrapper>
      ...
      <UxProject>
        ...
        <p className='subHeader'>
          ...
          consumption. We dicided to focus on food waste, becouse According to
          the National Food Administration, approximately 19 kilos of edible
          food are thrown in the rubbish and 26 kilos of food and drink are
          poured into the bin. The figures apply per person and year. Much of
          the food is thrown away because it is not eaten in time. First part of
          the discovery was to have a quick brainstorm session to expolre
          different ideas. The main idea we choose to
        </p>
