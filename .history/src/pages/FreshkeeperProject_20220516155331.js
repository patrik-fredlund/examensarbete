          ...
          <div className='uxProjectContainer'>
            <div className='competitorsContainer'>
              ...
              <p className='MiddleIngressParagraph'>
                ...
                <span className='bold'> Fridgely </span> are the main
                competitors. <br />
                To learn from them I decided to go directly to their users by
                reading the customer reviews of those apps. In that way I could
                get insight in the users <span className='bold'>
                  pains
                </span> and <span className='bold'>gains</span> when using that
                app, and use that to my advantage. I would also get valuble
                knowledge of the user needs when using an app like this.
                <img
                  className='reviews'
                ...
                <p className='imgText'>
                  {' '}
                  sample from the user reviews. useful insights highlighted in
                  red
                </p>
              </p>
            </div>
      ...
      <UxProject>
        ...
        <div className='insightsWrapper'>
          ...
          <div className='competitorsContainer'>
            ...
            <p className='ingressParagraph'>
              With those words in mind from the brainstorm, next step was to
              write down name suggestions that would apply to the value of the
              App to define what it is. It needs to be simple and traight to the
              point to communicate directly to the target group.
            </p>
            <img
              className='functionsImg'
