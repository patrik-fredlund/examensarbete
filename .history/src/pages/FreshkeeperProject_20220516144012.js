      ...
      <UxProject>
        ...
        <div className='insightsWrapper'>
          ...
          <div className='competitorsContainer'>
            ...
            <p className='ingressParagraph'>
              I'we already decied about the main features of the app: the
              register item and add expiration date and get an reminder when the
              date is close. From the target group research I also got alot of
              useful feedback as to what's imoportant to them when using these
              features. So now it's time to develop those features in detail to
              reach the user needs. From the feedback I also learned that the
