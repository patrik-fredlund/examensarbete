...
import { BsArrowDown } from 'react-icons/fa';
      ...
      <HeroWrapper>
        <HeroContainer>
          <div className='HeroStyle'>
            ...
            <p className='textBox'>
              I am a songwriting graphic designer with the hots for typoraphy,
              taglines and branding. I recently reskilled to a frontend
              developer to learn to design on the web, and In that process I
              fell in love in UX design.
            </p>
